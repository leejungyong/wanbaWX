...
switch ($act) {
    ...
    case 'editAct':
        ...
        $data = array('title' => $actdata['title'], 'date' => strtotime($actdata['date']), 'teamnum' => $teamnum, 'sharepic' => $sharepic, 'logopic' => $piclogo, 'slogan' => $actdata['text'], 'cat' => $actdata['cat']);
        //更新活动
        DB::update('wanba_act', $data, "aid=$aid");
    ...
    case 'updateRoutePic':
        $routeid = $arr['routeid'];
        $data = array('pic' => $routeid . '.jpg');
        $n = DB::update('wanba_routeapply', $data, "id=$routeid");
        echo json_encode($n);
        break;
    case 'updateLogoPic':
        $aid = $arr['aid'];
